      ...
      extraPolicies = {
        ...
        ExtensionSettings = let
          mozillaExtensions = {
            ...
            localcdn-fork-of-decentraleyes = "{b86e4813-687a-43e6-ab65-0bde4ab75758}";
      ...
      search = {
        ...
        engines = {
          "SearXNG" = {
            ...
            urls = [{
              template = "https://myprivatesrx.us/search";
              params = [
                {
                  name = "q";
                  value = "{searchTerms}";
        ...
        } // lib.genAttrs [ "Bing" "Amazon.com" "eBay" ] (engine: {metaData.hidden = true;});
      };
